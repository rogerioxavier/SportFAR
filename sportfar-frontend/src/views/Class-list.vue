    ...
    <div class="d-flex" style="margin-top: 20px">
      ...
      <div class="main-block w-100">
        <div class="sub-header d-flex align-items-end w-100">
          <div
            class="opt-modality d-flex align-items-center justify-content-center active"
          >
        ...
        <div class="submain-block">
          ...
          >
            <CardModality
              ...
              day="Sábados"
              hour="Das 10:00 ás 12:30"
              professor="Mauricio"
              color="#0D6EFD"
              :img="findImageInAssets('futebol.png')"
            />
            <CardModality
              icon='<i class="fa-light fa-user-tie"></i>'
              title="Categoria Sub-15"
              ...
              professor="Mauricio"
              color="#FF6607"
              :img="findImageInAssets('basquete.png')"
            />
            <CardModality
              icon='<i class="fa-light fa-user-tie"></i>'
              title="Categoria Sub-15"
              ...
              professor="Mauricio"
              color="#FFC107"
              :img="findImageInAssets('volei.png')"
            />
            <CardModality
              icon='<i class="fa-light fa-user-tie"></i>'
              title="Categoria Sub-15"
          ...
          >
            <p class="subtitle mt-0 mb-5">
              Ainda não foi registrado nenhuma turma
            </p>
